...
UI::UI(TurnEngine *t_e,Camera *camera,TTF_Font *font)
{
  ...
  menubars=new UI_Bars(t_e,camera,"Resources/UI/Buttons/move.png","Resources/UI/Buttons/attack.png",
		       "Resources/UI/Buttons/tome.png","Resources/UI/Buttons/backpack.png","Resources/UI/Buttons/x.png");
  ...
  spell_interface=new SpellInterface(t_e,dynamic_cast<Caster*>(KnowledgePool::Instance()->getCharacter(1)),camera,SDL_Rect{384,0,0,0});
	...
	case SDL_KEYDOWN:
	  {
		...
		*/
		...
		/*if(!spell_list->Shown())
		  {
		    bool cs_shown=char_sheet->Shown();
		    cs_shown=!cs_shown;
		    char_sheet->Show(cs_shown);
		    }*/
	      }
	    break;
	  }
