...
Anim::Anim(const Anim &ananim)
{
  this->x=ananim.x;
  this->y=ananim.y;
  this->w=ananim.w;
  this->h=ananim.h;
  this->numframes=ananim.numframes;
  this->current_frame=ananim.current_frame;
  if(ananim.frames!=NULL)
    {
...
SDL_Rect* Anim::getFrame(int framenum)
{
